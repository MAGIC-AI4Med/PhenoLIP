...
if __name__ == "__main__":
    # 1. 加载数据
    npz_path = "/mnt/petrelfs/liangcheng/hpo_feature/dino_features.npz"
    ...
    # 4. 保存聚类结果
    output_dir = "code_stage6/cluster/two_level_clustering_results"
    ...
    tb_log_dir = create_tensorboard_visualization(
        ...
        level1_labels,
        level2_labels,
        log_dir="code_stage6/cluster/two_level_tb_clustering_visualization",
        n_samples=5000
    )
